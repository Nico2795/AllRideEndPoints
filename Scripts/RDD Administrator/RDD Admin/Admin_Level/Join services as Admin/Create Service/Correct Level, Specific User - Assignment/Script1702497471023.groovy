...
reservationId2 = jsonResponse._id

//Imprimimos para corroborar
println("El id de la reserva es: " + reservationId2)


//Creamos una URL con el id de la reserva para asignar conductor
GlobalVariable.assignDriverUrl = "https://stage.allrideapp.com/api/v1/admin/pb/odd/assignDriver/${reservationId2}?community=${GlobalVariable.communityIdAdmin}"

//Creamos una URL con el id de la reserva para asignar el vehiculo
GlobalVariable.assignVehicleUrl = "https://stage.allrideapp.com/api/v1/admin/pb/odd/assignVehicle/${reservationId2}?community=${GlobalVariable.communityIdAdmin}"

//Creamos una URL con el id de la reserva recien creada para poder cancelarla desde el administrador
GlobalVariable.cancelUrlAdmin = "https://stage.allrideapp.com/api/v1/admin/pb/odd/cancel/${reservationId2}?community=${GlobalVariable.communityIdAdmin}"

//Convertimos la reservacion a variable global para corroborar que esté en el estado correcto
GlobalVariable.reservationId2 = reservationId2
