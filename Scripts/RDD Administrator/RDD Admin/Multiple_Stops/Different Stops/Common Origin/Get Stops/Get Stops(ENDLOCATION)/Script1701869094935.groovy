...
//Definir las variables globales de lat,lon,loc (ENDLOCATION)

GlobalVariable.endLocationName = paradaAleatoria.name
GlobalVariable.endLocationLat = paradaAleatoria.lat
GlobalVariable.endLocationLon = paradaAleatoria.lon
GlobalVariable.endLocationLoc = paradaAleatoria.loc
GlobalVariable.endLocationStopId = paradaAleatoria._id
GlobalVariable.endLocationPlaceId = paradaAleatoria.placeId
