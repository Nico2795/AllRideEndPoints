...
// Verificamos que el ID del servicio no se repita
def serviciosConMismoId = jsonResponse.findAll { it._id == serviceId }
assert serviciosConMismoId.size() == 1 : "Se encontraron duplicados del servicio con el ID: ${serviceId}"
