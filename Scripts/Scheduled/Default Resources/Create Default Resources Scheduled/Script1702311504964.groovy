...
//Se arma el cuerpo para la creacion de calendarizada con recursos por defecto

GlobalVariable.defaultResourcesScheduled = """

{
"name":"Prueba recursos por defecto ${GlobalVariable.todayDate}",
"description":"Se verifica que los recursos por defecto no ocasionen servicios duplicados",
"communities":[
...
//Se llama a la creación de esta ruta calendarizada
Response = WS.sendRequest(findTestObject('Object Repository/Scheduled/Create S-Default Resources'))
...
//Extraemos el id de la nueva ruta calendarizada con recursos predeterminados
