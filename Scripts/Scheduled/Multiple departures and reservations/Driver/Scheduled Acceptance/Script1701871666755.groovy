...
//Básicamente extraer el departureId que ya está almacenado y utilizarlo en la solicitud
Response = WS.sendRequest(findTestObject('Scheduled/DriverAcceptOrReject'))
