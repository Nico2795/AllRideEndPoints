...
GlobalVariable.urlGetServicesList = "https://stage.allrideapp.com/api/v1/admin/pb/services/day?community=653fd601f90509541a748683&startDate=${GlobalVariable.startDate}&endDate=${GlobalVariable.endDate}&routeId=${GlobalVariable.routeId}"
