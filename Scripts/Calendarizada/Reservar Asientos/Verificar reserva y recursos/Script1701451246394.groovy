...
GlobalVariable.urlGetServicesList = "https://stage.allrideapp.com/api/v1/admin/pb/services/day?community=653fd601f90509541a748683&startDate=2023-12-01T03:00:00.000Z&endDate=2023-12-03T02:59:59.999Z"

// Enviar la solicitud para obtener servicios
def response = WS.sendRequest(findTestObject('Object Repository/Calendarizada/Obtener_Servicios_Por_Dia'))
...
GlobalVariable.reservationsBeforeModification = [
	userId: reservationsUserID,
	seat: reservationsSeat,
	stopId: reservationsStopId
]

GlobalVariable.resourcesBeforeModification = [
	id: serviceResources
]
