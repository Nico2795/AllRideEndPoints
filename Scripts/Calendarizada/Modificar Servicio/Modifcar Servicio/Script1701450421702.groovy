...
{
  "serviceDate": "2023-12-01T22:00:00.000Z",
  "notificationOptions": {
    "notifyByEmail": true,
    "notifyByPush": true
  }
...
GlobalVariable.urlModifyService = "https://stage.allrideapp.com/api/v1/admin/pb/service/656a31da6796a160ae85ef47?community=653fd601f90509541a748683"

//Pedimos el servicio
Response = WS.sendRequest(findTestObject('Object Repository/Calendarizada/Modificar_Servicio'))
