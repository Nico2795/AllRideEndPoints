...
if (!comunidadNicoEnd.communities.privateBus.odd.needsAdminApproval) {
	...
	WebUI.comment('Activar el paso del Object Repository para enviar la solicitud PUT y actualizar needAdminApproval a true')
	WS.sendRequest(findTestObject('Object Repository/RDD/Modify-User-To-Request-Approval'))
	...
	println("El usuario 'Nico End' ya tiene needAdminApproval en true.")
}
