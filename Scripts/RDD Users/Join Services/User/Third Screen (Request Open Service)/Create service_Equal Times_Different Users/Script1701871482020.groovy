...
//Se arman las url de eliminacion para el usuario 1
GlobalVariable.deleteUrl = ('https://stage.allrideapp.com/api/v1/pb/user/oddepartures/reservation/' + reservationIdUser1)
