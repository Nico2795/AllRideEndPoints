...
ResponseObject response = WS.sendRequest(findTestObject('RDD/Get Places'))
...
for (def place : places) {
    try {
		...
		Response2= WS.sendRequest(findTestObject('RDD/Request ODD with Stop Not Configured'))
		...
		Response3 = WS.sendRequest(findTestObject('RDD/Get Reservations and Favorite Routes'))
