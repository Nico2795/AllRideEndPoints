...
ResponseUser2 = WS.sendRequest(findTestObject('RDD/PedirODD_Usuario2TiempoMayor'))
...
def user1Response = WS.sendRequest(findTestObject('RDD Admin/Obtener_Usuarios_Comunidad'))
...
def user2Response = WS.sendRequest(findTestObject('RDD Admin/Obtener_Usuarios_Comunidad'))
...
//Comprobamos que ambas ID son iguales y si es así significa que se unieron los servicios
if (reservationIdUser1 != reservationIdUser2) {
    println "Las Id de las reservas no son iguales, los servicios no se han unido"
} else {
    println "Los servicios se han unido"
}
