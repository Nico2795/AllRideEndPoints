...
if (jsonResponse.reservations && jsonResponse.reservations.size() > 0) {
    ...
    // If there are reservations, print a message and pass the test
    println("Se encontraron reservas. Esto es un resultado esperado.")
} else {
    // If there are no reservations, fail the test
    println("No se encontraron reservas")
    TestCase.fail("No se encontraron reservas. Esto no es un resultado esperado.")
}
